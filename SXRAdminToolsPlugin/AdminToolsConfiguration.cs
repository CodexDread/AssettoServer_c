...
public class AdminToolsConfiguration : IValidateConfiguration<AdminToolsConfigurationValidator>
{
    ...
    /// </summary>
    public string BanDatabasePath { get; init; } = "cfg/plugins/AdminToolsPlugin/bans.json";
    ...
    /// </summary>
    public string AuditLogPath { get; init; } = "cfg/plugins/AdminToolsPlugin/audit.log";
...
public class AdminToolsConfigurationValidator : IValidator<AdminToolsConfiguration>
{
    public bool Validate(AdminToolsConfiguration config, out string? errorMessage)
    {
