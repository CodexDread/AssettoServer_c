...
public class SPBattleConfiguration : IValidateConfiguration<SPBattleConfigurationValidator>
{
    /// <summary>
    ...
    /// </summary>
    public string LeaderboardPath { get; init; } = "cfg/plugins/SPBattlePlugin/leaderboard.json";
...
public class SPBattleConfigurationValidator : IValidator<SPBattleConfiguration>
{
    public bool Validate(SPBattleConfiguration config, out string? errorMessage)
    {
        if (config.TotalSP <= 0)
        {
