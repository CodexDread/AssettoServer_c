--[[
    SP Battle Plugin - TXR-Style In-Game UI
...
local battleStatusEvent = ac.OnlineEvent({
    ...
    ac.debug("SP Battle Event", data.eventType)
...
if config.enableLeaderboard then
    ui.registerOnlineExtra(ui.Icons.Leaderboard, "SP Battle Rankings", function() return true end, function()
